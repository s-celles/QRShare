...
- **One-to-Many WebRTC Broadcasting (Mesh Network):** Extend the 1-to-1 WebRTC capability to support broadcasting files to an entire "Room". Receivers could exchange pieces of the file among themselves (BitTorrent style) using WebRTC Data Channels to relieve the upload bandwidth of the original sender.
